...
import TomarMomentosScreen from "./TomarMomentos/TomarMomentos";
import MisMomentosScreen from './MisMomentos/MisMomentos';
import MomentosScreen from "./screens/Momentos";
...
const ScreenStack = () => {
  return (
    ...
    headerTitleStyle: {
      ...
      <Stack.Screen name="Momentos" component={MomentosScreen} 
      options={{
        tabBarLabel: 'Momentos',
        tabBarIcon: () => <Icon name="home" color="#7CDCC1" size={24} />,
      }}/>

      <Stack.Screen name="TomarMomentos" component={TomarMomentosScreen} 
      options={{
        tabBarLabel: 'Tomar Momentos',
        tabBarIcon: () => <Icon name="camera" color="#7CDCC1" size={24} />,
        }}/>
      <Stack.Screen name="MisMomentos"  component={MisMomentosScreen} 
      options={{
